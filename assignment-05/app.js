...
/* Qno:1 Write a program that take two numbers & add them in a new variable. Show the result in your browser.
 ...
 document.write(The total cost buy 5 ticket to a movie is ${total} PKR)
 ...
 document.write(Price of item 1 is ${itemPrice1})
 document.write("</br>")
 document.write(Quantity of item 1 is ${quantityOfItem1})
 document.write("</br>")
 document.write(Price of item 2 is ${itemPrice2})
 document.write("</br>")
 document.write(Quantity of item 2 is ${quantityOfItem2})
 document.write("</br>")
 document.write(Shiping charges ${shippingCharges})
 document.write("<br> <br>")

 document.write(Total cost of your order is ${totalCost})

 Qno:8  Store total marks & marks obtained by a student in 2 variables. Compute the percentage & show the result in
 your browser
 ...
 document.write("<h2>Age Calculator</h3>")
 document.write("<br><br>")
 ...
 document.write(The area is: ${area})
  ...
  Qno:13 The Lifetime Supply Calculator: Ever wonder how much a “lifetime supply” of your favorite snack is? Wonder no more.
 ...
 document.write(`Esimated Maximam Age: ${maximumAge} </br> `)
